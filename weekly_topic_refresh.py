...
def run_weekly_refresh(
    ...
    if scrape:
        ...
        try:
            ...
            results["steps"]["scrape"] = {"success": False, "error": str(e)}
            return results
    ...
    if score:
        ...
        try:
            ...
            results["steps"]["score"] = {"success": False, "error": str(e)}
            return results
    ...
    if curate:
        ...
        try:
            ...
            results["steps"]["curate"] = {"success": False, "error": str(e)}
    ...
    if plan_episode:
        ...
        try:
            ...
            results["steps"]["plan"] = {"success": False, "error": str(e)}
    ...
    results_file = (
        output_dir / f"refresh_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
...
if __name__ == "__main__":
    ...
    # Run refresh
    run_weekly_refresh(scrape=scrape, score=score, curate=curate, plan_episode=plan)
