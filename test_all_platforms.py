...
if ready_count == total_count:
    ...
    print(
        f"[INFO] {ready_count} platform(s) ready. Configure remaining platforms to enable full automation."
    )
else:
    print(
        "[WARNING] No platforms configured. Set up API credentials to enable automation."
    )
print()
