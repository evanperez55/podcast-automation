# Life Bridge Church - Outreach Pitch
...
I'd like to process your next 4 sermons completely free. No strings - you keep everything. If you like the output, we talk about automating the whole thing. If not, you've got a month of free content for Life Bridge Church.
...
Also: I checked, and Life Bridge Church doesn't have searchable sermon transcripts on your website. That means Google can't index any of the teaching you've delivered. With 52 sermons a year and 100 sermons already archived, you're sitting on a major SEO opportunity that most churches miss.
...
- [ ] Update outreach tracker with email: `uv run main.py outreach update life-bridge-church-green-bay contact_email=<email>`
- [ ] Send Tue-Thu morning (10am-2pm ET for best B2B open rates)
- [ ] Mark contacted: `uv run main.py outreach update life-bridge-church-green-bay contacted`
...
- **Archive size:** 100 episodes
- **RSS feed:** see `clients/life-bridge-church-green-bay.yaml`
- **Tier:** 1
- **Why this angle:** Newer podcast, likely volunteer-run. Time savings + automation speaks directly to comms bandwidth pain.
