...
Also: I checked, and Christ Community Church doesn't have searchable sermon transcripts on your website. That means Google can't index any of the teaching you've delivered. With 52 sermons a year and 565 sermons already archived, you're sitting on a major SEO opportunity that most churches miss.
...
- [ ] Update outreach tracker with email: `uv run main.py outreach update christ-community-church-johnson-city contact_email=<email>`
- [ ] Send Tue-Thu morning (10am-2pm ET for best B2B open rates)
- [ ] Mark contacted: `uv run main.py outreach update christ-community-church-johnson-city contacted`
...
- **Archive size:** 565 episodes
- **RSS feed:** see `clients/christ-community-church-johnson-city.yaml`
- **Tier:** 2
