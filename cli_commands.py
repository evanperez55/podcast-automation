"""Client-management CLI subcommand handlers.

Extracted from main.py to keep the CLI entry point thin. All of these commands
...
def activate_client(client_name: str | None) -> None:
    ...
    from client_config import activate_client as _activate

    _activate(client_name)
