...
- [x] **VOICE-04**: Chapter markers auto-generated from transcript segments and embedded in MP3 ID3 tags
- [x] **VOICE-05**: Chapter markers included in RSS feed for podcast apps
...
- [x] **DEBT-01**: main.py split into pipeline/ package with modular step classes and PipelineContext dataclass
...
- [x] **DEBT-05**: continue_episode.py eliminated by delegating to extracted pipeline steps
