...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print(
            "Usage: python setup_dropbox_oauth_quick.py <app_key> <app_secret> [auth_code]"
        )
        print()
        print("Example:")
        print(
            "  Step 1: python setup_dropbox_oauth_quick.py nllyfhg1l322hzk c5r5993ae0u3b50"
        )
        print("  Step 2: Open the URL, get the code, then:")
        print(
            "  Step 3: python setup_dropbox_oauth_quick.py nllyfhg1l322hzk c5r5993ae0u3b50 YOUR_AUTH_CODE"
        )
        sys.exit(1)
    ...
    if len(sys.argv) >= 4:
        ...
        print()
        print(
            f"python setup_dropbox_oauth_quick.py {app_key} {app_secret} YOUR_AUTH_CODE_HERE"
        )
        print()
