...
class KeywordTopicMatcher:
    ...
    def match_topic_to_episode(
        self, topic_text: str, episode: Dict
        ...
        episode_text += " ".join(
            [clip["description"] for clip in episode["best_clips"]]
        )
    ...
    def match_all_topics(self, topics: List[Dict], episodes: List[Dict]) -> List[Dict]:
